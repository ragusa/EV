/**
 * \file TransportUpwindAnalyticSSFCTFilter.cc
 * \brief Provides the function definitions for the
 *        TransportUpwindAnalyticSSFCTFilter class.
 */
 ...
 */
template <int dim>
TransportUpwindAnalyticSSFCTFilter<dim>::TransportUpwindAnalyticSSFCTFilter(
 ...
 */
template <int dim>
void TransportUpwindAnalyticSSFCTFilter<dim>::filter_antidiffusive_fluxes(
 ...
 */
template <int dim>
bool TransportUpwindAnalyticSSFCTFilter<dim>::check_bounds(
 ...
 */
template <int dim>
Vector<double> TransportUpwindAnalyticSSFCTFilter<dim>::get_lower_solution_bound()
  const
{
 ...
 */
template <int dim>
Vector<double> TransportUpwindAnalyticSSFCTFilter<dim>::get_upper_solution_bound()
  const
{
 ...
 */
template <int dim>
void TransportUpwindAnalyticSSFCTFilter<dim>::compute_solution_bounds(
  const Vector<double> & solution,
