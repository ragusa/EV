/**
 * \file TransportAnalyticThetaFCTFilter.cc
 * \brief Provides the function definitions for the
 *        TransportAnalyticThetaFCTFilter class.
 */
 ...
 */
template <int dim>
TransportAnalyticThetaFCTFilter<dim>::TransportAnalyticThetaFCTFilter(
 ...
 */
template <int dim>
void TransportAnalyticThetaFCTFilter<dim>::filter_antidiffusive_fluxes(
 ...
 */
template <int dim>
bool TransportAnalyticThetaFCTFilter<dim>::check_bounds(
 ...
 */
template <int dim>
void TransportAnalyticThetaFCTFilter<dim>::compute_solution_bounds(
  const Vector<double> & solution,
