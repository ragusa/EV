 ...
 */
template <int dim>
OldFCT<dim>::OldFCT(const DoFHandler<dim> & dof_handler,
...
template <int dim>
void OldFCT<dim>::solve_FCT_system_fe(
  ...
  const double & t_old)
{
  ...
  linear_solver.solve_with_dirichlet(
    system_matrix, new_solution, system_rhs, true);
 ...
 */
template <int dim>
void OldFCT<dim>::compute_bounds_fe(
  const Vector<double> & old_solution,
  const SparseMatrix<double> & low_order_ss_matrix,
  const Vector<double> & ss_rhs,
  const double & dt,
 ...
 */
template <int dim>
void OldFCT<dim>::compute_bounds_theta(
 ...
 */
template <int dim>
void OldFCT<dim>::compute_bounds_ss(
 ...
 */
template <int dim>
void OldFCT<dim>::compute_flux_corrections_fe(
 ...
 */
template <int dim>
void OldFCT<dim>::compute_flux_corrections_theta(
  const Vector<double> & high_order_solution,
  const Vector<double> & old_solution,
  const double & dt,
  const SparseMatrix<double> & low_order_diffusion_matrix,
 ...
 */
template <int dim>
void OldFCT<dim>::compute_flux_corrections_ss(
  const Vector<double> & high_order_solution,
  const SparseMatrix<double> & low_order_diffusion_matrix,
  const SparseMatrix<double> & high_order_diffusion_matrix)
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_limited_flux_bounds_fe(
  const Vector<double> & old_solution,
  const SparseMatrix<double> & low_order_ss_matrix,
  const Vector<double> & ss_rhs,
  const double & dt)
 ...
 */
template <int dim>
void OldFCT<dim>::compute_limited_flux_bounds_theta(
  const Vector<double> & new_solution,
  const Vector<double> & old_solution,
  const SparseMatrix<double> & low_order_ss_matrix,
  const Vector<double> & ss_rhs_new,
 ...
 */
template <int dim>
void OldFCT<dim>::compute_limited_flux_bounds_ss(
  const Vector<double> & solution,
  const SparseMatrix<double> & low_order_ss_matrix,
  const Vector<double> & ss_rhs)
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_limited_fluxes()
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_limited_flux_matrix()
{
 ...
 */
template <int dim>
bool OldFCT<dim>::check_fct_bounds(const Vector<double> & solution) const
{
 ...
 */
template <int dim>
void OldFCT<dim>::debug_max_principle_low_order(
  const unsigned int & i,
  const SparseMatrix<double> & low_order_ss_matrix,
  const double & dt)
{
 ...
 */
template <int dim>
bool OldFCT<dim>::check_DMP_satisfied()
{
 ...
 */
template <int dim>
void OldFCT<dim>::output_bounds(PostProcessor<dim> & postprocessor) const
{
 ...
 */
template <int dim>
Vector<double> OldFCT<dim>::get_limited_flux_vector() const
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_function_bounds(FunctionParser<dim> & function,
                                          const double & time,
 ...
 */
template <int dim>
void OldFCT<dim>::compute_function_bounds(const FunctionParser<dim> & function,
                                          Vector<double> & min_values,
                                          Vector<double> & max_values) const
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_min_max_solution(const Vector<double> & solution,
 ...
 */
template <int dim>
void OldFCT<dim>::compute_and_apply_analytic_bounds(
  const Vector<double> & solution, const double & dt, const double & time_old)
{
 ...
 */
template <int dim>
void OldFCT<dim>::compute_row_sums(const SparseMatrix<double> & matrix,
 ...
 */
template <int dim>
void OldFCT<dim>::subtract_limited_flux_correction_matrix()
{
