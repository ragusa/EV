/**
 * \file TransportAnalyticFEFCTFilter.cc
 * \brief Provides the function definitions for the
 *        TransportAnalyticFEFCTFilter class.
 */
 ...
 */
template <int dim>
TransportAnalyticFEFCTFilter<dim>::TransportAnalyticFEFCTFilter(
 ...
 */
template <int dim>
void TransportAnalyticFEFCTFilter<dim>::filter_antidiffusive_fluxes(
 ...
 */
template <int dim>
bool TransportAnalyticFEFCTFilter<dim>::check_bounds(
 ...
 */
template <int dim>
Vector<double> TransportAnalyticFEFCTFilter<dim>::get_lower_solution_bound() const
{
 ...
 */
template <int dim>
Vector<double> TransportAnalyticFEFCTFilter<dim>::get_upper_solution_bound() const
{
 ...
 */
template <int dim>
void TransportAnalyticFEFCTFilter<dim>::compute_solution_bounds(
  const Vector<double> & old_solution,
  const double & dt,
  const Vector<double> &,
  const Vector<double> &,
  const double & t_old)
{
  ...
  analytic_bounds.update(old_solution, dt, t_old);
}
