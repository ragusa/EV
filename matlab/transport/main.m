...
%                  3 = theta method
opts.temporal_scheme = 2; % temporal discretization scheme
            ...
            switch opts.temporal_scheme
                ...
                case 2 % SSP3
                    ...
                    [uH_stage,DH] = high_order_step(u_older_stage,...
                        u_old_stage,dt_old,dt,A,b,MC,0,viscL,mesh,phys,...
                        quadrature,dof_handler,ev,opts);
                    [uFCT_stage,Wminus,Wplus] = FCT_step_explicit(...
                        u_old_stage,uH_stage,dt,...
                        ML,MC,AL,DH,DL,b,...
                        sigma_min,sigma_max,source_min,source_max,...
                        source_over_sigma_min,source_over_sigma_max,...
                        mesh,phys,fct_opts,opts);
