...
\input{content/scalar_discretization}
\input{content/scalar_low}
\input{content/scalar_high}
\input{content/scalar_fct}
\input{content/nonlinear_iteration}
\input{content/scalar_results}

\input{content/systems_discretization}
\input{content/sw_low}
\input{content/sw_high}
\input{content/systems_fct}
\input{content/sw_results}
