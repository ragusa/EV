...
\newcommand{\celldomain}{\mathcal{D}_\cell}
...
\newcommand{\indicescell}[1][]{\ifthenelse{\equal{#1}{}}{\mathcal{I}_{\cell}}
  {\mathcal{I}_{#1}}}
...
\newcommand{\entropynormalization}{\alpha}
...
\newcommand{\wavespeed}{\lambda}
\newcommand{\maxwavespeed}{\wavespeed_{\text{max}}}
...
\newcommand{\sumKSij}{\sum\limits_{\cell:\celldomain\subset\support_{i,j}}}
