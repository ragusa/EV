...
\newcommand{\indicescell}[1][]{\ifthenelse{\equal{#1}{}}{\indices(\cell)}
  {\indices(#1)}}
...
\newcommand{\analyticDMPbounds}{\solutionbound^{\text{analytic},\pm}}
\newcommand{\analyticDMPupperbound}{\solutionbound^{\text{analytic},+}}
\newcommand{\analyticDMPlowerbound}{\solutionbound^{\text{analytic},-}}
...
\newcommand{\sumKSij}[1][\cell]
  {\sum\limits_{#1\in\cellindices_{i,j}}}
