...
Section \ref{sec:abbreviations} lists the abbreviations used in this dissertation,
Section \ref{sec:symbols} lists the symbols used in this dissertation,
and Section \ref{sec:conventions} discusses conventions used in this dissertation.
...
SSPRK33 & 3-stage, 3-order-accurate SSPRK scheme,\\
        & also known as the Shu-Osher method\\
\end{longtable}
