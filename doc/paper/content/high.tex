...
instead of the standard Galerkin method as has been used previously in FCT-FEM schemes;
 for Galerkin FCT-FEM examples, see, for instance, \cite{kuzmin_FCT} \tcr{can we add a few more;
 also we do not discuss this enough int he introduction; please add some there too}.
