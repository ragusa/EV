...
otherwise specified, the transport direction is in the postive
...
\clearpage
%===============================================================================
\subsection{Obstruction}\label{sec:obstruction}
%===============================================================================
...
CFL numbers. Recall that in the FCT algorithm, one first computes the high-order
(EV) solution, which is necessary for computation of the antidiffusive fluxes.
...
emerges is an alternation between two solutions indefinitely, with each generating
solution bounds that produce the other. Thus the nonlinear convergence stalls
indefinitely, thus demonstrating a severe disadvantage of implicit FCT.
%-------------------------------------------------------------------------------
