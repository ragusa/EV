...
\tcr{be ready to have a review ask what the color mean. You should really try to put a colorbar to explain the numerical range of the solution}
...
\tcr{I understand the fail in the FCT column but why are there no numbers in the last row for EV?}
%-------------------------------------------------------------------------------
