...
discontinuous FEM \cite{maginot_mc2015}. \tcr{I think a paper with Pete is out now}
...
applied to the particle transport equation. \tcr{concur?} 
...
geometries \cite{lohner}. \tcr{I think there should be a couple of sentences and several
refs to Kuzmin's work as well.}
...
and Popov \tcr{but Kuzmin's as well...}, but is extended to allow application to the transport equation,
